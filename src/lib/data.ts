...
export const product = {
  ...
  fileSize: "~159 MB",
  fileName: "Aspizo-Traffic-Analyzer-Setup-3.4.10.exe",
  sha256:
    "2AAEBEF2A029AC15752E854DB9F62DDF326E406BBDFC2EF9B07EE6D35065268F",
  downloadUrl:
    "https://github.com/Ashu2244/Aspizo-website/releases/download/v3.4.10/Aspizo-Traffic-Analyzer-Setup-3.4.10.exe",
  enginePort: 8765,
  uiPort: 3000,
};
...
export const installSteps = [
  "Download Aspizo-Traffic-Analyzer-Setup-3.4.10.exe from this page",
...
export const docsSections = [
  {
    title: "Installation",
    content:
      "Download Aspizo-Traffic-Analyzer-Setup-3.4.10.exe from the Download page and run the installer. Open the Desktop shortcut — the app UI opens immediately; first-run engine setup runs in the background (may take several minutes online). No ZIP extract, no START-ASPIZO.bat, no CMD windows for clients.",
  },
  {
